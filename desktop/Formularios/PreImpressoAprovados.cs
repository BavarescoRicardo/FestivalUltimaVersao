...
{
    public partial class PreImpressoAprovados : Form
    {        
        public PreImpressoAprovados()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                AprovadosReport reportApr = new AprovadosReport();
                ...
                try
                {
                    ...
                    reportApr.DataSource = listaDto.OrderBy(x => x.nomeartistico);
                }
                catch (Exception)
                {
